...
const DashboardTabs = () => {
    ...
    return (
        <div className={'flex h-full w-[20%] max-md:w-[75%] max-md:gap-1 max-[55rem]:w-[30%] max-[65rem]:w-[35%] shadow-sm dark:shadow-white/40 px-2 py-2 rounded-full max-md:rounded-md bg-slate-800/5 dark:bg-slate-100/5 justify-evenly items-center font-semibold'}>
            <button
                className={`cursor-pointer hover:bg-slate-800/7 border-2 hover:opacity-90 transition-all
                 duration-300 border-slate-800/10 p-1 rounded-full max-md:rounded-md w-[95px] flex justify-center items-center
