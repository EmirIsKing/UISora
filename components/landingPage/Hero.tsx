...
const Hero = () => {
  return (
    <div className='relative px-14 max-md:px-6 pt-12 max-md:pt-8 bg-gradient-to-b from-background to-background/50 min-h-[750px]'>
        ...
        <div className='relative w-full h-full flex gap-16 max-md:gap-12 flex-col justify-center items-center'>
            <div className='flex flex-col gap-9 max-md:gap-4'>
                ...
                <h1 className='h1 !text-[20px] text-wrap text-muted-foreground text-center'>Describe your app vision, and watch our AI create stunning, mobile interfaces in<br/>
                seconds</h1>
            </div>
