...
const NormalRenderer = ({index, processedAttributes, type, content}:{index:number|undefined, processedAttributes:Record<string, unknown>, content:(string | HtmlElement)[], type:string}) => {
