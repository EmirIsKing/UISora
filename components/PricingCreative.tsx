          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="my-12">
              ...
              >
                <div
                  aria-hidden="true"
                  className={`bg-purple-blue ring-foreground/5 pointer-events-none absolute inset-1 w-1/2 rounded-full border border-transparent shadow ring-1 transition-transform duration-500 ease-in-out ${
            ...
            <div className="mx-auto max-w-5xl">
              <div className="grid grid-cols-2 gap-6 *:p-8">
                ...
                <motion.div
                  ...
                  className="group bg-background relative flex cursor-pointer flex-col overflow-hidden rounded-2xl border p-8"
                  data-animate-card
                >
                  <div className="card-content relative z-10 flex h-full flex-col">
                    ...
                    {/* Description */}
                    <p className="text-foreground/70 mb-6 flex-grow text-sm leading-relaxed mb-16">
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="space-y-3">
                        ...
                        'No exports (images or UI files)',
                        'Basic email support'].map((item) => (
                          <li
                ...
                <motion.div
                  ...
                  className="group bg-primary relative flex cursor-pointer flex-col overflow-hidden rounded-2xl border p-8"
                  data-animate-card
                >
                  {/* Gradient Accent */}
                  ...
                  <div className="card-content relative z-10 flex h-full flex-col">
                    ...
                    {/* Description */}
                    <p className="text-foreground/70 mb-6 flex-grow text-sm leading-relaxed mb-16">
                      For professionals building full UI projects at scale.
                    </p>
